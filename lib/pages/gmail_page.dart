...
class AppGmailMain extends StatefulWidget {
  const AppGmailMain({super.key, required this.title});

  final String title;

  @override
  State<AppGmailMain> createState() => _MyHomePageState();
}


class _MyHomePageState extends State<AppGmailMain> {
